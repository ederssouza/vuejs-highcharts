<template>
  <div class="container">
    <div class="select__container">
      <select v-model="option" class="select" @change="renderMock">
        <option value="oneDay">Um dia (segunda)</option>
        <option value="oneDaySunday">Um dia (domingo)</option>
        <option value="oneWeek">Uma semana</option>
        <option value="biweekly">15 dias</option>
        <option value="mondayIsFirstDay">1 mês (1º dia segunda)</option>
        <option value="sundayIsFirstDay">1 mês (1º dia domingo)</option>
        <option value="threeMonths">2 meses</option>
        <option value="twoMonths">3 meses</option>
      </select>
    </div>
  ...
  methods: {
    ...
    renderChart () {
      ...
      console.table({
        arr: arr.length,
        diff,
        complementArray: complementArray.length,
        categories
      })
